package dev.qruet.decompiler.ui.util;
...
public class JavaStyler implements LineStyleListener {
    ...
    void initializeColors() {
        ...
        colors = new Color[]{
                ...
                new Color(display, new RGB(217, 63, 63)), // red
                new Color(display, new RGB(0, 204, 0)), // green
                new Color(display, new RGB(217, 142, 64)) // orange
        };
